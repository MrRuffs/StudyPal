...
async function fetchUsername() {
    try {
        const response = await fetch("http://0.0.0.0:10000/get-username", {
            method: "GET",
            headers: {
...
async function fetchSubjects() {
    const access_token = localStorage.getItem("token");
    try {
        const response = await fetch("http://0.0.0.0:10000/get-subjects", {
            method: "GET",
            headers: {
...
async function fetchDecks(subjectId) {
    const access_token = localStorage.getItem("token");
    try {
        const response = await fetch(`http://0.0.0.0:10000/get-decks?subject_id=${subjectId}`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${access_token}`
            }
...
document.getElementById("createDeckFormInModal").addEventListener("submit", async function (event) {
    ...
    try {
        const response = await fetch("http://0.0.0.0:10000/create-deck-api", {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${localStorage.getItem("token")}`,
...
async function deleteSubject(subjectId) {
    try {
        const response = await fetch("http://0.0.0.0:10000//delete-subject-api", {
            method: "DELETE",
            headers: {
                "Authorization": `Bearer ${localStorage.getItem("token")}`,
                "Content-Type": "application/json"
...
async function deleteDeck(deckId) {
    try {
        const response = await fetch("http://0.0.0.0:10000/delete-deck-api", {
            method: "DELETE",
            headers: {
                "Authorization": `Bearer ${localStorage.getItem("token")}`,
                "Content-Type": "application/json"
...
document.getElementById("createSubjectForm").addEventListener("submit", async function (event) {
    ...
    try {
        const response = await fetch("http://0.0.0.0:10000//create-subject-api", {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${access_token}`,
                "Content-Type": "application/json"
